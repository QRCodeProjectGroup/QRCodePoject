        ...
        <div className="container-fluid " id="footerContainer">
           ...
           <p className="mt-5"> QR menü ile ilgili bilgi almak istiyorsanız,yazın biz size dönelim!</p>
                    ...
                    <div className="row">
                        <div className="col">
                            <div className="mb-3">
                                <label for="exampleFormControlInput1" className="form-label mt-3">Email adresiniz:</label>
                                <input type="email" className="form-control" id="exampleFormControlInput1" placeholder="name@example.com" />
                            </div>
                            <div className="mb-3">
                                <label for="exampleFormControlTextarea1" className="form-label">Mesajınız:</label>
